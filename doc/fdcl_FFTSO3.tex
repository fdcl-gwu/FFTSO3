...
\end{align*}
From now on, it is assumed that $l_1\leq l_2$ without loss of generality. 
...
Then, 
\begin{align}
    U^{l_1}(R) \otimes U^{l_2}(R) & = c_{l_1,l_2} \bracket{ \bigoplus_{l=|l_1-l_2|}^{l_1+l_2} U^l(R) } c_{l_1,l_2}^*.
\end{align}
