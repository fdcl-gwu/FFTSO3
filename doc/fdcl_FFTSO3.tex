...
\begin{align*}
    S_l = C_l Y_l,
\end{align*}
where $S_l$ is the $2l+1$-by-one column whose elements are composed of $S_{l,m}$ for $m\in\{-l,\ldots l\}$ in the ascending order, and $Y_l$ is defined similarly. 
The matrix $C_l\in\C^{(2l+1)\times(2l+1)}$ is defined as
\begin{align*}
    C_l=\frac{1}{\sqrt{2}}
    \begin{bmatrix}
