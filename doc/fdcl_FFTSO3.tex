...
\begin{equation}
    U^l (R) = \overline{C^l} D^l(R) (C^l)^T.
\end{equation}
Each element of $U^l$ is given by
\begin{align}
    U^l_{m,n}(R) & = \sum_{p,q} \overline{C}^l_{m,p} C_{n,q} D^l_{p,q} (R).
\end{align}
According to the sign of $m,n$, there are four cases of the above equation.
\begin{align*}
...
\end{align*}
The last three cases are further divided for $m,n>0$ into
\begin{align*}
    U^l_{m,0} (R) &= \overline{C}^l_{m,m} D^l_{m,0} (R) + \overline{C}^l_{m,-m} D^l_{-m,0} (R),\\
    U^l_{-m,0} (R) &= \overline{C}^l_{-m,-m} D^l_{-m,0} (R) + \overline{C}^l_{-m,m} D^l_{m,0} (R),\\
    U^l_{0,n} (R) &= C_{n,n} D^l_{0,n}(R) + C_{n,-n} D^l_{0,-n}(R),\\
...
Using the symmetry of the wigner-$d$ functions, and after rearranging, 
\begin{align*}
    U^l_{m,0} (R) &= (-1)^m \sqrt{2} d^l_{m,0}(\beta) \cos m\alpha, \\
    U^l_{-m,0} (R) &= (-1)^m \sqrt{2} d^l_{m,0}(\beta) \sin m\alpha = \sqrt{2} d^l_{-m,0}(\beta) \sin m\alpha,\\
    U^l_{0,n} (R) &= (-1)^{n} \sqrt{2} d^l_{0,n}(\beta) \cos n\gamma, \\ 
    U^l_{0,-n} (R) &= (-1)^{n+1} \sqrt{2} d^l_{0,n}(\beta) \sin n\gamma = -\sqrt{2} d^l_{0,-n}(\beta) \sin n\gamma,\\
    ...
    U^l_{-m,-n} (R) & = d^l_{-m,-n}(\beta) \cos (m\alpha + n\gamma) - (-1)^n d^l_{-m,n}(\beta) \cos(-m\alpha + n\gamma).
\end{align*} 
