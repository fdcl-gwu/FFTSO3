...
\begin{align}
    \tilde f^l_m = \sum_{j=0}^{2B-1}  e^{-im\phi_j} \sum_{k=0}^{2B-1} w_k f(\theta_k,\phi_j)\Theta^l_m(\theta_k)
    = \sum_{j=0}^{2B-1} e^{-im\phi_j} F^l_m(j)
\end{align}
...
\begin{align}
    \tilde f^l_m =  \sum_{k=0}^{2B-1} w_k \Theta^l_m(\theta_k)   F_{k,m}.
\end{align}
