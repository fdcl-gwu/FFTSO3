...
test_FFTSO3: test_FFTSO3.o fdcl_FFTSO3.o fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o 
	g++ -o test_FFTSO3  test_FFTSO3.o fdcl_FFTSO3.o fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o -lm $(CFLAGS) $(OPTI_FLAGS)
