...
test_FFTSO3: test_FFTSO3.o fdcl_FFTS2.o fdcl_Clebsch_Gordon.o fdcl_FFTSO3.o  fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o fdcl_FFTS2_matrix.o
	g++ -o test_FFTSO3  test_FFTSO3.o fdcl_FFTS2.o fdcl_Clebsch_Gordon.o fdcl_FFTSO3.o fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o fdcl_FFTS2_matrix.o -lm $(CFLAGS) $(OPTI_FLAGS)
...
fdcl_Clebsch_Gordon.o: fdcl_Clebsch_Gordon.hpp fdcl_Clebsch_Gordon.cpp
	g++ -c fdcl_Clebsch_Gordon.cpp $(CFLAGS) $(OPTI_FLAGS)
