...
test_FFTSO3: test_FFTSO3.o fdcl_FFTS2.o fdcl_Clebsch_Gordon_matrix.o fdcl_FFTSO3_real.o fdcl_FFTSO3_complex.o fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o fdcl_FFTS2_matrix.o
	g++ -o test_FFTSO3  test_FFTSO3.o fdcl_FFTS2.o fdcl_Clebsch_Gordon_matrix.o fdcl_FFTSO3_real.o fdcl_FFTSO3_complex.o fdcl_FFTSO3_matrix.o fdcl_tictoc.o misc_matrix_func.o fdcl_FFTS2_matrix.o -lm $(CFLAGS) $(OPTI_FLAGS)
