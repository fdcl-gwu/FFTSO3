...
Eigen::VectorXd fdcl_FFTSO3_complex::Legendre_poly(double x, int N)
{
...
int fdcl_FFTSO3_complex::signum(int x)
{
    int y;
    if (x > 0)
        y=1;
...
double fdcl_FFTSO3_complex::delta(int i, int j)
{
    double delta=0.;
...
complex<double> fdcl_FFTSO3_complex::f_4_check_forward_transform(double alpha, double beta, double gamma)
{
    complex<double> y={0.,0.};
    int L=3;
    fdcl_FFTSO3_complex tmp(L); 
    fdcl_FFTSO3_matrix_complex D(L);
...
void fdcl_FFTSO3_complex::check_forward_transform()
{
    fdcl_FFTSO3_matrix_complex F(l_max), F_0(l_max);
    cout << "fdcl_FFTSO3_complex::check_forward_transform" << endl;
    ...
    cout << "fdcl_FFTSO3_complex::check_forward_transform:completed" << endl << endl;
}
